...
def compteMedailles(df, start_year, end_year, medal_type = 'All', edition = ALL_SEASON):
    """_summary_
    ...
    if medal_type == 'All':
        ...
        bronze = compteMedailles(df, start_year, end_year, medal_type = 'Bronze', edition = edition)
